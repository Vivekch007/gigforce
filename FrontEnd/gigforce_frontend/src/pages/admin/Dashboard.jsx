      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="row row-cols-2 row-cols-md-4 row-cols-lg-9 g-3 mb-4">
            ...
            <div className="col">
              <AdminMetricCard title="Organizations" value={metrics?.totalOrgs} desc="Tenant companies" borderStartClass="border-start border-4 border-primary" />
            </div>
            <div className="col">
            ...
            <div className="col">
              <AdminMetricCard title="Pending Req" value={0} desc="User requests pending" borderStartClass="border-start border-4 border-warning" />
            </div>
          </div>
            ...
            <Col lg={8}>
              <Card className="gf-card p-4 border-0 mb-4 bg-white">
                ...
                <div className="d-flex flex-wrap gap-2">
                  ...
                  <Button variant="outline-primary" className="py-2 px-3 flex-grow-1" onClick={() => navigate('/admin/roles')}>
                ...
                <Row className="g-3 text-center">
                  <Col md={3}>
                    <div className="border rounded p-3 bg-light">
                      <span className="small text-muted font-bold text-uppercase d-block mb-1">Online Users</span>
                      <h4 className="fw-black text-slate-800 mb-0">{metrics?.healthMetrics?.onlineUsers}</h4>
                    </div>
                  </Col>
                  <Col md={3}>
                    <div className="border rounded p-3 bg-light">
                  ...
                  <Col md={3}>
                    <div className="border rounded p-3 bg-light">
                      <span className="small text-muted font-bold text-uppercase d-block mb-1">Active Sessions</span>
                      <h4 className="fw-black text-slate-800 mb-0">{metrics?.healthMetrics?.activeSessions}</h4>
                    </div>
                  </Col>
                </Row>
