...
import { getSkills, getMockCatalogSkills, addCatalogSkill, editCatalogSkill, deleteCatalogSkill, createSkill } from '../../services/skillCatalogService';
              ...
              <tbody>
                {skillsList.map(s => (
                  <tr key={s.id}>
                    ...
                    <td>
                      <span className={`gf-badge badge-${getStatusBadge(s.status)}`}>
                        {s.status}
                      </span>
                    </td>
                    <td className="small text-muted">{s.createdBy}</td>
                    <td className="small text-muted">{s.lastUpdated}</td>
                    <td className="text-end">
                      <div className="d-flex gap-2 justify-content-end">
                        ...
                        <Button 
                          size="sm" 
                          variant={s.status === 'ACTIVE' ? 'outline-danger' : 'outline-success'} 
