            ...
            <Col lg={8}>
              ...
              <Card className="gf-card p-4 border-0 bg-white">
                ...
                <div className="row g-3 text-center">
                  ...
                  <div className="col-4">
                    <div className="border rounded p-3 bg-light">
                      <span className="small text-muted font-bold text-uppercase d-block mb-1">Processing</span>
                      <h4 className="fw-black text-amber-600 mb-0">{metrics?.paymentSummary?.processing || 0}</h4>
                    </div>
                  </div>
                  <div className="col-4">
                    <div className="border rounded p-3 bg-light">
