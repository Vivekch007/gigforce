...
const SEARCH_PLACEHOLDERS = {
  ...
  '/manager/assignments': 'Search active placements...',
...
const SIDEBAR_LINKS = [
  ...
  { to: '/manager/assignments', label: 'Active Placements', icon: 'bi bi-briefcase' },
  ...
  { to: '/manager/invoice-creation', label: 'Safeguard Invoicing', icon: 'bi bi-shield-check' },
    ...
    <div className="app-layout-shell">
      <header className="enterprise-global-header">
        <div className="logo-container">
          <NavLink to="/manager/dashboard" className="gf-brand-logo">
