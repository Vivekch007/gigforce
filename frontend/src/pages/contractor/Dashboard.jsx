    ...
    <div className="container-fluid">
      ...
      <div className="row">
        ...
        <div className="col-lg-8">
          ...
          <div className="gf-card">
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h5 className="fw-bold text-slate-800 mb-0">Recent Timesheets</h5>
              ...
              <Table responsive hover className="align-middle border-top text-sm mb-0">
                ...
                <tbody>
                  {recentTimesheets.slice(0, 3).map((ts) => (
                    <tr key={ts.id}>
                      <td className="fw-semibold text-slate-800">
                        {ts.weekStartDate} to {ts.weekEndDate}
                      </td>
                      <td>{ts.hoursLogged ?? '0.00'} hrs</td>
                      <td>{ts.overtimeLogged ?? '0.00'} hrs</td>
                      <td className="text-green-600 fw-semibold">${ts.billableAmount ?? '0.00'}</td>
                      <td>
                        <span className={`gf-badge badge-${ts.status.toLowerCase()}`}>
                          {ts.status}
                        </span>
                      </td>
                    </tr>
