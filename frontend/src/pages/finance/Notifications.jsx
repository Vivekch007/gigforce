...
import { Spinner, Alert, Card, Button, ButtonGroup } from 'react-bootstrap';
import { getMyNotifications } from '../../services/financeNotificationService';
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="mb-4">
        ...
        <p className="text-muted small mt-1 mb-0">Review system activity alerts, vendor PO updates, and banking settlement feeds.</p>
      </div>
      ...
      <div className="mb-4 overflow-auto py-1">
        <ButtonGroup className="d-flex flex-wrap flex-md-nowrap gap-1">
          {['ALL', 'PURCHASE_ORDER', 'INVOICE', 'PAYMENT'].map((cat) => (
            <Button
              key={cat}
      ...
      {loading ? (
        <LoadingSpinner message="Loading financial alerts..." />
