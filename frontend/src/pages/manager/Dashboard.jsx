            ...
            <div className="col-xl col-md-4 col-sm-6">
              <div className="gf-card mb-0 p-3 h-100 d-flex flex-column justify-content-between">
                <div>
                  ...
                  <h3 className="fw-black text-indigo-600 mt-1 mb-0">${parseFloat(stats.totalSpend || 0).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</h3>
                </div>
                <p className="text-muted small mb-0 mt-2">Approved & paid invoice total</p>
              </div>
            </div>
          </div>
                    ...
                    <div style={{ width: '130px', height: '130px', position: 'relative' }}>
                      <svg viewBox="0 0 36 36" className="w-100 h-100">
                        ...
                        <circle cx="18" cy="18" r="15.915" fill="none" stroke="#10b981" strokeWidth="2.5" 
                                strokeDasharray={`${stats.fillRate} ${100 - stats.fillRate}`} strokeDashoffset="25" />
                      </svg>
                      <div className="position-absolute start-50 top-50 translate-middle text-center">
                        <div className="fs-4 fw-black text-slate-800">{stats.fillRate}%</div>
